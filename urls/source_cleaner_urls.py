...
# === СИЛЬНЫЕ ФИЛЬТРЫ МУСОРА ===
BAD_EXT = ['.lua', '.luau', '.apk', '.exe', '.zip', '.rar', '.tar', '.pdf', '.mp4', '.mp3', '.png', '.jpg', '.gif']
BAD_KW = ['apple.com', 'releases', 'hiddify', 'karing', 'pywarp', 'docker', 'facebook', 'music', 'book', 'quote', 'youtube', 'boosty', 'blog.', 'medium.com']
